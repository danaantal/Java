...
public class PostGetCandidates {
	WriteFile writeInFile = new WriteFile();
	ReadFile readMyFile = new ReadFile();

	@Test
	public void postThenGetCandidatesDetails() throws Exception{
		...
		ArrayList<String> field = readMyFile.readCandidate(candidatesFile); //read the candidate details from file
		...
		writeInFile.writeInFile(response, postGetCandidates); //write response into file
	}
